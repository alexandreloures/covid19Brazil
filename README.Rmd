...
To install the `package`, one of the two standard methods for installing `packages`in R can be adopted. Through the [cran] (https://cran.r-project.org/package=covid19brazil):
