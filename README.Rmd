...
The graph below shows the number of cases accumulated in each Federative Unit of Brazil per 100,000 inhabitants (data for the day 2022-11-15).
...
The next graph refers to the number of cases accumulated per 100,000 inhabitants for the state Minas Gerais (data for the day 2022-11-15).

<img src="man/figures/mgCases100.png" width="100%" />

## Deaths accumulated per 100,000 inhabitants

In turn, the next graph shows the number of deaths accumulated in each Federative Unit of Brazil per 100,000 inhabitants (data for the day 2022-11-15).
...
The next graph refers to the number of accumulated deaths per 100,000 inhabitants for state of Minas Gerais (data for the day 2022-11-15).
