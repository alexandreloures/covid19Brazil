...
The graph below shows the number of cases accumulated in each Federative Unit of Brazil per 100,000 habitants (data for the day 2022-10-27).
...
In turn, the next graph shows the number of deaths accumulated in each Federative Unit of Brazil per 100,000 habitants (data for the day 2022-10-27).
